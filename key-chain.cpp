...
KeyChain::addCertificate(const Key& key, const Certificate& certificate)
{
  ...
  PibBlock *newBlock = new PibBlock(certificate.getName().toUri());
...
/*unique_ptr<PibBlockchain>
KeyChain::createCertChain()
{
  return unique_ptr<PibBlockchain>(new PibBlockchain()); 
}
*/
